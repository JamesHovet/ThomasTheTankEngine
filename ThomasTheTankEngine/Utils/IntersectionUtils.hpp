...
bool RayPlaneAbsolute(ray r, Plane p, float * d, glm::vec4* hit);
bool RayPlaneAbsolute(ray r, Plane p, glm::vec4* hit);
bool RayPlaneAbsolute(ray r, Plane p, float * d);
bool RayPlaneAbsolute(ray r, Plane p);

bool RayPlane(ray r, Plane p, float * d, glm::vec4* hit);
bool RayPlane(ray r, Plane p, glm::vec4* hit);
bool RayPlane(ray r, Plane p, float * d);
bool RayPlane(ray r, Plane p);

AABB AABBUnion(AABB a, AABB b);

bool RayAABBAbsolute(ray r, AABB box, float * d, glm::vec4* hit);
bool RayAABBAbsolute(ray r, AABB box, glm::vec4* hit);
bool RayAABBAbsolute(ray r, AABB box, float * d);
bool RayAABBAbsolute(ray r, AABB box);

bool RayAABB(ray r, AABB box, glm::mat4 model, float * d, glm::vec4* hit);
bool RayAABB(ray r, AABB box, glm::mat4 model, glm::vec4* hit);
bool RayAABB(ray r, AABB box, glm::mat4 model, float * d);
bool RayAABB(ray r, AABB box, glm::mat4 model);

bool RayOBB(ray r, AABB box, glm::mat4 model, float * d, glm::vec4* hit);
bool RayOBB(ray r, AABB box, glm::mat4 model, glm::vec4* hit);
bool RayOBB(ray r, AABB box, glm::mat4 model, float * d);
bool RayOBB(ray r, AABB box, glm::mat4 model);

bool RayCylAbsolute(ray r, Cylinder cyl, float * d, glm::vec4* hit);
bool RayCylAbsolute(ray r, Cylinder cyl, glm::vec4* hit);
...
bool RayCyl(ray r, Cylinder cyl, glm::mat4 model, float * d, glm::vec4* hit);
bool RayCyl(ray r, Cylinder cyl, glm::mat4 model, glm::vec4* hit);
